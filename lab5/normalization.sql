...
CREATE TABLE addresses (
    ...
    CONSTRAINT fk_addresses_settlement FOREIGN KEY (settlement_id) REFERENCES settlements(id)
);
...
CREATE TABLE shipments (
    ...
    country_snapshot VARCHAR(100) NOT NULL,
    city_snapshot VARCHAR(100) NOT NULL,
    street_snapshot VARCHAR(150) NOT NULL,
    building_snapshot VARCHAR(20) NOT NULL,
    apartment_snapshot VARCHAR(20),
    zip_code_snapshot VARCHAR(20) NOT NULL,
